  ...
  return (
    <>
      ...
      <div className="btn flex justify-center flex-col mt-5">
        ...
        <button className='mt-3 p-2 bg-slate-800 w-60 m-auto border rounded-lg border-gray-50 hover:bg-red-400' onClick={() => router.push('LearnScriptComponents')}> Learn Script Components </button>
      </div>
